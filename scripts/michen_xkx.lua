...
SetOption("arrow_recalls_partial",1)
...
SetOption("keep_commands_on_same_line",0)
...
SetOption("output_font_height",12)
...
for i=1,table.getn(loadlua_list) do
	...
	print(loadlua_list[i].."模块加载成功！")
end
--[[for k,v in ipairs(loadlua_list) do 
	loadmod(v)
	print(v.."模块加载成功！")
end]]
...
ColourNote("red","blue","本RBT由Michen按照Kissls版本zmud7.21完整重写而成")
